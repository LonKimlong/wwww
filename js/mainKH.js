...
function renderTable() {
  ...
  for (let i = 0; i < users.length; i++) {
    ...
    editBtn.innerText = "កែប្រែ";
    deleteBtn.innerText = "លុប";
...
function showpopup() {
  ...
  if (overlay.classList.toggle("show")) {
    button.textContent = "បិទ";
    button.style.backgroundColor = "Red";
    button.style.padding = "7px 30px";
  } else {
    button.textContent = "បង្ហាញ";
...
function swictpopup() {
  window.location.href = "http://127.0.0.1:5500/view/indexEng.html";
}
